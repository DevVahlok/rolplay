...
public class HabilidadesBonificadoresFragment extends Fragment {
    ...
    private CheckBox mAcrobaciasCB, mAtletismoCB, mConocimientoCB, mEngañoCB, mHistoriaCB, mInterpretacionCB,
            ...
            mPersuasionCB, mReligionCB, mSigiloCB, mSupervivenciaCB, mTratoAnimalesCB, mFuerzaCB, mDestrezaCB,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Checkbox tiradas de salvacion
        mFuerzaCB = v.findViewById(R.id.HabilidadesBonificadores_tiradasSalvacion_checkbox_fuerza);
        mDestrezaCB = v.findViewById(R.id.HabilidadesBonificadores_tiradasSalvacion_checkbox_destreza);
        mConstitucionCB = v.findViewById(R.id.HabilidadesBonificadores_tiradasSalvacion_checkbox_constitucion);
        mInteligenciaCB = v.findViewById(R.id.HabilidadesBonificadores_tiradasSalvacion_checkbox_inteligencia);
        mSabiduriaCB = v.findViewById(R.id.HabilidadesBonificadores_tiradasSalvacion_checkbox_sabiduria);
        mCarismaCB = v.findViewById(R.id.HabilidadesBonificadores_tiradasSalvacion_checkbox_carisma);
        ...
        if (recuperados != null) {
            ...
            mFuerzaCB.setChecked(recuperados.getBoolean("FuerzaCB"));
            mDestrezaCB.setChecked(recuperados.getBoolean("DestrezaCB"));
            mConstitucionCB.setChecked(recuperados.getBoolean("ConstitucionCB"));
            mInteligenciaCB.setChecked(recuperados.getBoolean("InteligenciaCB"));
            mSabiduriaCB.setChecked(recuperados.getBoolean("SabiduriaCB"));
            mCarismaCB.setChecked(recuperados.getBoolean("CarismaCB"));
        }
    ...
    public void onPause() {
        ...
        hashMap.put("FuerzaCB", mFuerzaCB.isChecked());
        hashMap.put("DestrezaCB", mDestrezaCB.isChecked());
        hashMap.put("ConstitucionCB", mConstitucionCB.isChecked());
        hashMap.put("InteligenciaCB", mInteligenciaCB.isChecked());
        hashMap.put("SabiduriaCB", mSabiduriaCB.isChecked());
        hashMap.put("CarismaCB", mCarismaCB.isChecked());
