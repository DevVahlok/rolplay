...
public class PuntosHabilidadFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Generación de estadísticas: si se quiere rerollear, hay que dar un número aleatorio entre 3-18 (ambos incluídos) [colocar en el cuadrado]
        ...
        Tabla de puntuación [cuadrado] - modificador [círculo]
        1 -> -5
        2,3 -> -4
        4,5 -> -3
        6,7 -> -2
